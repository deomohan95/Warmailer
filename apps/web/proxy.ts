...
function setSessionCookies(response: NextResponse, session: { access_token: string; refresh_token: string; expires_in: number }, secure: boolean) {
...
export async function proxy(request: NextRequest) {
  ...
  setSessionCookies(response, session, request.nextUrl.protocol === "https:");
  return response;
}
